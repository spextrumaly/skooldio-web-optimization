...
$(".countdown-time").each(function () {
  ...
  $(this).countdown(endTime, function (tm) {
    $(this).html(
      tm.strftime(
        '<span class="countdown-box"><span class="countdown days">%D </span><span class="cd-text">Days</span></span><span class="countdown-box"><span class="countdown hours">%H</span><span class="cd-text">Hours</span></span><span class="countdown-box"><span class="countdown minutes">%M</span><span class="cd-text">Minutes</span></span><span class="countdown-box"><span class="countdown seconds">%S</span><span class="cd-text">Seconds</span></span>'
      )
    );
  });
});
...
function getAccordion(element_id, screen) {
  ...
  if ($(window).width() < screen) {
    ...
    jQuery.each(obj_tabs, function (n, val) {
      ...
      concat +=
        '<h4 class="panel-title"><a id="predict' +
        n +
        '" role="button" data-toggle="collapse" data-parent="#tab-accordion" href="#collapse' +
        n +
